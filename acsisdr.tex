...
\citep[][\ascl{1310.001}]{2011tfa..confE..42J,2008AN....329..295C} that was already in
...
\caption{Example of a reduced spectrum affected by a bad baseline.
 ...
 panel shows the correspnoding spectrum after the application of
...
\begin{figure}[!ht]
\includegraphics[width=\columnwidth]{P61_f2a}
\caption{Examples of low-frequency interference.  The upper graphic
 shows a band of low-frequency oscillations; below it is the band's
 average spectrum.  The lower spectrum has a periodic weak
 ripple hard to detect visually.}
...
\caption{Comparison of an integrated intensity map using the same
  ...
  high- and low-frequency interference filters.}
