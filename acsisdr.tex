...
{Tim~Jenness,$^{1,2}$\thanks{Contact email: t.jenness@lsst.org}\thanks{Present address: LSST Project Office, 933 N.\ Cherry Ave, Tucson, AZ~85721, USA}
...
\begin{figure}
\includegraphics[width=\columnwidth]{high_freq_three_types.pdf}
...
\begin{figure*}
\begin{minipage}{\textwidth}
\includegraphics[width=\textwidth]{NGC1333_badbaseline_removal.pdf}
\caption{A bad-spectra comparison displayed in an integrated intensity map.
  ...
  No flatfield correction has been applied.}
...
\begin{figure*}
\begin{minipage}{\textwidth}
\includegraphics[width=\textwidth]{12CO_flat_comparison.pdf}
\caption{A flat-field comparison displayed in an integrated intensity
  ...
  images are scaled to the same temperature limits.}
