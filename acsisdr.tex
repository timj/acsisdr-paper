...
\citep[e.g.,][]{2015HDS} using the extensible \emph{N}-Dimensional
Data Format \citep[NDF;][]{2015NDF}. The spectral data are stored in a
...
the heterodyne data file format can be found in \citet{OCS_ICD_022}.
