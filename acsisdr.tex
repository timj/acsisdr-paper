...
instruments \citep{1992IJIMW..13.1487P,1992IJIMW..13..647D,1992IJIMW..13.1827C} to small
focal plane arrays \citep{2003SPIE.4855..322G,2004A&A...423.1171S} to
16 element arrays such as HARP at JCMT \citep{2009MNRAS.399.1026B},
and correlators have improved such that we can easily obtain spectra
at 10\,Hz with 8192 channels (AOSC,DAS,ACSIS) data rates have
increased substantially such that it is now common-place to take a
short observation resulting in thousands of spectra. This is only
...
Description from David on how MAKECUBE works out the correct gridding.
...
Early HARP data from 2006 seemed to have problems with the relatives
...
\citep{1982QJRAS..23..485D,2005ASPC..347...22D} and then opened up to the
community. The source code is
