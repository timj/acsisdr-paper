...
\caption{Two integrated intensity images from the same set of
  ...
  parameters. The top figure uses a naive sum over a significant part
  of the baseline. The lower figure uses the automated baseline
  masking.}
\label{fig:integ}
\end{figure}
...
14,000 spectra from 154 observations spread over 12 nights. Reducing
the data with SPECX was an involved process and preliminary results
were presented in \citet{2001AAS...19915601S}. The GSD data were
