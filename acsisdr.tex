...
Starlink \KAPPA\ \citep[][\ascl{1403.022}, see \S\ref{sec:mfittrend}]{SUN95,2008ASPC..394..650C}, to determine
...
\begin{figure}[!ht]
\includegraphics[width=0.46\textwidth]{raw_edginess_profile.png}
...
\begin{figure}[!ht]
\includegraphics[width=0.46\textwidth]{ringing_edginess_profile.png}
\caption{The edginess profile after masking the short-duration
  interference, leaving the ringing signal.}
