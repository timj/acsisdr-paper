...
in a time and detector domain. The \smurf\ \unmakecube\ task
...
detectors to exclude the effects of strong non-linearity in one or two
...
calibration of the detectors. A self flatfielding algorithm was
developed that relied on the detectors on average seeing the same
