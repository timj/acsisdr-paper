...
positions using an arbitrary tangent plane projection that has 1
arc-min square pixels with north upwards and the target position (or
the first supplied sky position if no target position is available) at
pixel (1,1).
...
divided up into sections of length 1 arc-min, and a histogram formed
